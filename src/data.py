...
def get_data_loaders(
    ...
    data_transforms = {
        "train": transforms.Compose(
            ...
            transforms.RandAugment(num_ops=5, magnitude=9, interpolation=transforms.InterpolationMode.BILINEAR),
        ...
        "valid": transforms.Compose(
            [
            #no augmentation for valid dataset
            transforms.Resize(256),
        ...
        "test": transforms.Compose(
            [
            #no augmentation for test dataset also.
            transforms.Resize(256),
            transforms.CenterCrop(224),
            transforms.ToTensor(),
            transforms.Normalize(mean, std)
